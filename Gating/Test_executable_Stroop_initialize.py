...
from Preparation_functions import Prep_Stroop_test_initialize as P
from Model_functions import model_test_fun_basic as T

#Define setings of previous simulations
resources = 12
Dir = "/Volumes/backupdisc/Modular_learning/Data_Revision/initialize/Stroop/" #"/data/gent/430/vsc43099/GatingModel_data/"
...
def Gen_fun(core=0):
    ...
    for lr in learning_rates:
        ...
        for r in range(Rep):
            ...
            #Prepare data
            Dat = P.Generalization_preparation(nContexts=5, Directory = Dir, Model=Models[core%4], ntrep=5, lr=lr, r=r, resources=resources, initial = initial)
