...
from Preparation_functions import Prep_Trees_test as P
from Model_functions import model_test_fun_basic as T

#Define setings of previous simulations
resources = 24
Dir = "/Volumes/backupdisc/Modular_learning/Data_Revision/Trees/"+ str(resources)+"/" #"/data/gent/430/vsc43099/GatingModel_data/"
