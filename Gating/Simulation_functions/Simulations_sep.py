from Model_functions import model_sim_fun_sep as mf
...
def Simulation(nContexts = 5, nRepeats = 3, ntrep = 25, resources = 24, learning_rates = np.arange(0,1.1,0.1), Rep = [0,30], Model = 1, Directory = "/Volumes/backupdisc/Modular_learning/Data_Stroop/Revision/", mout=False, dat="Stroop"):
    if dat == "Stroop":
        ...
        data_dir = "/Users/pieter/Desktop/DataFolder/"#"/Volumes/backupdisc/Modular_learning/Data_Revision/"#"/data/gent/430/vsc43099/GatingModel_data/"#
    ...
    for lr in learning_rates:
        for r in range(Rep[0],Rep[1]):
            ...
            if Model ==0:
                Adapt_mult = mf.Model_multiplicative(Data["Inputs"], Contexts, Objectives, nRepeats, Data["Part_trials"], lr, True, resources, mout)
                ...
                Nonadapt_mult = mf.Model_multiplicative(Data["Inputs"], Contexts, Objectives, nRepeats, Data["Part_trials"], lr, False, resources, mout)
                ...
                Adapt_add = mf.Model_additive(Data["Inputs"], Contexts, Objectives, nRepeats, Data["Part_trials"], lr, True, resources, mout)
                ...
                Nonadapt_add = mf.Model_additive(Data["Inputs"], Contexts, Objectives, nRepeats, Data["Part_trials"], lr, False, resources, mout)
