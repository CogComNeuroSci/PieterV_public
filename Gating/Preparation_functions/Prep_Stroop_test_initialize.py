...
def Generalization_preparation(nContexts = 5, nRepeats = 3, Directory = "", Model="Adaptive_mult", ntrep = 25, lr=0, r=0, resources=12, initial = "normal"):
    ...
    Data = np.load(Directory + Model +"/" + initial +"_lr_{:.1f}_Rep_{:d}.npy".format(lr, r), allow_pickle=True)
