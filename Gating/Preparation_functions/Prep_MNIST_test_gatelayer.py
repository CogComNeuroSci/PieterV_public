...
def Generalization_preparation(nContexts = 5, nRepeats = 3, Directory = "", Model="Adaptive_mult", Trial_percentage = 0.05, lr=0, r=0, xdat = np.random.random((100,28,28)), ydat = np.random.random((100)), g =0):
    ...
    Data = np.load(Directory + Model + "/Gat{:d}_lr_{:.2f}_Rep_{:d}.npy".format(g, lr, r), allow_pickle = True)
    ...
    if "add" in Model:
        Output = {
            ...
            "Hidden_weights": Data[()]["Trained_Hidden_Weights"][nRepeats-1,O[nContexts-1],:,:],
        ...
        if g ==3:
            Output = {
                ...
                "Overlap": Overlap,
                "Input_weights": Data[()]["Trained_Input_Weights"][nRepeats-1,O[nContexts-1],:,:],
                "Context_weights": [Data[()]["Trained_Context_Weights_1"][nRepeats-1,O[nContexts-1],:,:],Data[()]["Trained_Context_Weights_2"][nRepeats-1,O[nContexts-1],:,:]] ,
                "Hidden_weights": Data[()]["Trained_Hidden_Weights"][nRepeats-1,O[nContexts-1],:,:],
                "Output_weights": Data[()]["Trained_Output_Weights"][nRepeats-1,O[nContexts-1],:,:],
                "Stim_labels": ydat[id]
                }
            ...
            Output = {
                ...
                "Overlap": Overlap,
                "Input_weights": Data[()]["Trained_Input_Weights"][nRepeats-1,O[nContexts-1],:,:],
                "Context_weights": np.zeros((6,300)),
                "Hidden_weights": Data[()]["Trained_Hidden_Weights"][nRepeats-1,O[nContexts-1],:,:],
                "Output_weights": Data[()]["Trained_Output_Weights"][nRepeats-1,O[nContexts-1],:,:],
                "Stim_labels": ydat[id]
                }
