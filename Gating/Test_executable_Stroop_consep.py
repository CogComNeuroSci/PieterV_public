...
from Preparation_functions import Prep_Stroop_test_consep as P


#Define setings of previous simulations
resources = 12
Dir = "/Volumes/backupdisc/Modular_learning/Data_Revision/conc/Stroop/" #"/data/gent/430/vsc43099/GatingModel_data/"
...
def Gen_fun(core=0):
    ...
    Dir = "/Volumes/backupdisc/Modular_learning/Data_Revision/"+ method +"/Stroop/"
    i=-1
    for lr in learning_rates:
        ...
        for r in range(Rep):
            ...
            #Prepare data
            Dat = P.Generalization_preparation(nContexts=5, Directory = Dir, Model=Models[core%4], ntrep = 5, lr=lr, r=r, resources=resources)
            ...
            if (core%4)<2:
                ...
                Result = T.Generalization_additive(Dat["Inputs"], Dat["Contexts"], Dat["Context_weights"], Dat["Input_weights"], Dat["Output_weights"], Dat["CorResp"], True)
