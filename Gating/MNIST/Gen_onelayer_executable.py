...
import Generalization_onelayer_fun as T

Dir = "/Volumes/backupdisc/Modular_learning/Data_MNIST/Onelayer/"#"/data/gent/430/vsc43099/GatingModel_data/"
...
def Gen_fun(core=0):
    ...
    for lr in learning_rates:
        ...
        Result_dictionary={
            ...
            "Activation": np.zeros((Rep, 401, 6, 500)),
