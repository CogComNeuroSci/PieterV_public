...
def Simulation(nContexts = 6, nRepeats = 3, Trial_percentage = 0.2, resources = np.array([300, 100]), learning_rates = np.arange(0,0.11,0.01), Rep = 50, Model = 1):

    Order = np.arange(nContexts)
    Directory = "/Volumes/backupdisc/Modular_learning/Data_MNIST/"#"/data/gent/430/vsc43099/GatingModel_data/"
