...
def Model_multiplicative(Inputs, Contexts, Objectives, nRepeats, Part_trials, learning_rate, gate_learning = True, resources = 24, multout = False, initial = "normal"):
...
def Model_additive(Inputs, Contexts, Objectives, nRepeats, Part_trials, learning_rate, gate_learning = True, resources = 24,  multout = False, initial = "normal"):
    ...
    W_hid_out=np.random.normal(size=(nHidden, nOutput))
    if initial != "normal":
        W_inp_hid[0:nContexts, :]=np.random.uniform(size=(nContexts, nHidden-1))
