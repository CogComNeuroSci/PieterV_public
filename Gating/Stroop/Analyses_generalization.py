...
Directory = "/Volumes/backupdisc/Modular_learning/Data_Stroop/"
...
def load_data(Directory = "/Volumes/backupdisc/Modular_learning/Data_Stroop/", learning_rates= np.arange(0,1.1,0.1), Rep= 50, Models= ["Adaptive_mult", "Non_adaptive_mult", "Adaptive_add", "Non_adaptive_add"], resources = 24, nContexts= 5, nRepeats= 3, nPatterns = 18):
...
figdir = "/Volumes/backupdisc/Modular_learning/Plots_Stroop"
...
for m in range(len(Models)):
    for l in range(len(learning_rates)):
        for r in range(Rep):
            ...
            Correlation_12[m,l,r] = stats.spearmanr(actual_12, target_12)[0]#np.corrcoef(actual_12, target_12)[0,1]
            Correlation_24[m,l,r] = stats.spearmanr(actual_12, target_12)[0]#np.corrcoef(actual_24, target_24)[0,1]
...
np.save(Directory + "RDM_gen_Stroop_2.npy", Stroop_RDM_gen_dir)
...
l = 5
r = 1
objective_dissimilarity = 1 - target_overlap_12[m,l,r,:,:]
hidden_activation_stim1 = activation_12[m,l,r,:,:,0]
hidden_activation_stim2 = activation_12[m,l,r,:,:,5]
hidden_activation_stim3 = activation_12[m,l,r,:,:,12]
hidden_activation_stim4 = activation_12[m,l,r,:,:,17]

RDM = Overlap_12_average[m,l,r,:,:]
...
axs[0,0].imshow(RDM, cmap="jet")
axs[1,0].imshow(objective_dissimilarity, cmap="jet")
axs[0,1].imshow(hidden_activation_stim1, cmap="jet")
axs[1,1].imshow(hidden_activation_stim2, cmap="jet")
axs[0,2].imshow(hidden_activation_stim3, cmap="jet")
axs[1,2].imshow(hidden_activation_stim4, cmap="jet")

plt.savefig("Illustration_methods.png", dpi = 300)

print(Correlation_12[m,l,r])
