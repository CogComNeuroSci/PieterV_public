...
from Preparation_functions import Prep_MNIST_test_threelayer as P
from Model_functions import model_test_fun_threelayer as T

Dir = "/Volumes/backupdisc/Modular_learning/Data_Revision/MNIST/threelayer/"#"/data/gent/430/vsc43099/GatingModel_data/"
...
def Gen_fun(core=0):
    ...
    Result_dictionary={
        ...
        "Activation": np.zeros((np.size(learning_rates),Rep, 403, 6, 500)),
    ...
    for lr in learning_rates:
        ...
        for r in range(Rep):
            ...
            if core<2:
                Result = T.Generalization_multiplicative(Dat["Inputs"], Dat["Contexts"], Dat["Context_weights"], Dat["Input_weights"], Dat["Hidden1_weights"], Dat["Hidden2_weights"], Dat["Output_weights"], Dat["CorResp"])
            else:
                Result = T.Generalization_additive(Dat["Inputs"], Dat["Contexts"], Dat["Input_weights"], Dat["Hidden1_weights"],  Dat["Hidden2_weights"], Dat["Output_weights"], Dat["CorResp"])
