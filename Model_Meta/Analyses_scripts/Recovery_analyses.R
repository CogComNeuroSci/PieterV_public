...
ggsave("Parameter_distributions_recovery.jpg", Distributions_recovery_plot, device = "jpeg", width = 15, height = 10, units = "cm", dpi = 300, path = Endfolder)
...
ggsave("Recovery_both.jpg", recovery_both, device ="jpeg", width = 17, height = 7.5, units ="cm", dpi=300, path =Endfolder )
