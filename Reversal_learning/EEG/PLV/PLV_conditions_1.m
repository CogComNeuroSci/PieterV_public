...
timestep=1000/srate;                                 %length of one timestep
time_feedback=-1000:timestep:2500;                   %time
...
for s=1:num_subjects
    ...
    %compute imaginary phase locking values
    for c1=1:n_channels
        for c2=1:n_channels
