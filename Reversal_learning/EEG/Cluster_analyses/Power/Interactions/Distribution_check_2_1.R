...
estobs 	= readMat("FB_Cluster_statistic_PE.mat")
estobs 	= estobs$statistic
estimates 	= as.vector(estobs)
estimates1 	= estimates[order(estimates)] 

estobs 	= readMat("FB_random_statistic_PE.mat")
estobs 	= estobs$statistic
estimates 	= as.vector(estobs)
estimates2 	= estimates[order(estimates)] 


tiff("Overview voxel statistics Feedback PE.tiff", width = 1500, height = 750)
