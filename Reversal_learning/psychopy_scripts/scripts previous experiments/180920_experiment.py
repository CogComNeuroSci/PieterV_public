...
check_stim      = visual.TextStim(window,text=( "Wat denk je dat de regel is op dit moment?\n\n"+
                                                "Druk op '1' als je denkt dat de regel is:\n"+
                                                "Verticaal-rechts, horizontaal-links\n\n"+
                                                "Druk op '2' als je denkt dat de regel is:\n"+
                                                "Verticaal-links, horizontaal-rechts"),wrapWidth=50, units="deg")                                                
...
for trial in range(Ntrials):
    ...
    pp_rule = event.waitKeys(keyList = ["1","2"])
    trials.addData("pp_rule",int(pp_rule[0])-1)
    thisExp.nextEntry()
