...
instruct        = visual.TextStim(window,text=( "Hieronder zie je een voorbeeld van de stimuli.\n\n"
                                                ...
                                                "Druk op spatie om om verder te gaan."),wrapWidth=50, height=0.75, units="deg",alignHoriz='center', alignVert='bottom')
...
vert_grating=visual.GratingStim(win=window,tex='sin', mask='raisedCos',ori=45, pos=(0,0), size= (5,5), units='deg', interpolate=False)
hor_grating=visual.GratingStim(win=window,tex='sin', mask='raisedCos',ori=135, pos=(0,0), size= (5,5), units='deg', interpolate=False)
gratings=[vert_grating,hor_grating]

example_1=visual.GratingStim(win=window,tex='sin', mask='raisedCos',ori=45, pos=(-7,-5), size= (5,5), units='deg', interpolate=False)
example_2=visual.GratingStim(win=window,tex='sin', mask='raisedCos',ori=135, pos=(7,-5), size= (5,5), units='deg', interpolate=False)
...
goodbye         = visual.TextStim(window,text=( "Dit is het einde van de oefenfase.\n\n"+
                                                ...
                                                "Check voor afnemer = {}").format(str(points),str(check*100)),wrapWidth=50, height=0.75, units="deg",alignHoriz='center', alignVert='bottom')
goodbye.draw()
window.flip()
event.waitKeys(keyList = "space")
